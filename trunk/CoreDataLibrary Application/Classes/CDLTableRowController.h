//MOTableRowCellTypeSingleLineLargeLabelInCell
//  ManagedObjectRowRowController.h
...
typedef enum _MOTableRowType {
	...
	CDLTableRowTypeRelationship, //represents a relationship, will use MOTableRowCellTypeSingleLineValueLargeLabel for a toOne relationship or MOTableRowCellTypeSingleLineValueNoLabel for toMany relationships (one row per value)
